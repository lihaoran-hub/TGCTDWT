...
from model.LSTM import STGCN as LSTM
...
if __name__ == '__main__':
    ...
    for epoch in range(args.epochs):
        ...
        # if epoch>0 and epoch%50==0:
            # np.savetxt("./results_noC/pred_result_" + str(epoch) + ".csv", X.cpu().detach().numpy(), delimiter=',')
            # np.savetxt("./results_noC/true_result_" + str(epoch) + ".csv", Y.cpu().detach().numpy(), delimiter=',')
